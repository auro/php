...
<html>
<head>
<title>O dominio <?php echo $domain; ?> esta a venda.</title>
...
?>
<h3>O dominio <b><?php echo $domain; ?></b> esta a venda.</h3>
<form action="https://pagseguro.uol.com.br/checkout/v2/payment.html" method="post">
<input type="hidden" name="code" value="F75D44E58383E64DD49FBF95FC018372" />
<input type="hidden" name="item_id" value="<?php echo $domain; ?>" />
<input type="hidden" name="iot" value="button" />
<input type="image" src="https://stc.pagseguro.uol.com.br/public/img/botoes/pagamentos/209x48-comprar-assina.gif" name="submit" alt="Compre agora o dominio <?php echo $domain; ?> com o PagSeguro!!!" />
</form>
</body>
</html>
